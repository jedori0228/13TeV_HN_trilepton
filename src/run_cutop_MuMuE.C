...
void run_cutop_MuMuE(int sig_mass){
            ...
            for(unsigned int i_HN_mass=0; i_HN_mass<cuts_HN_mass.size(); i_HN_mass++){
              for(unsigned int i_deltaR_OS_min=0; i_deltaR_OS_min<cuts_deltaR_OS_min.size(); i_deltaR_OS_min++){
                for(unsigned int i_gamma_star_mass=0; i_gamma_star_mass<cuts_gamma_star_mass.size(); i_gamma_star_mass++){
                  ...
                  m_data.SearchRegion = "Preselection_MuMuE";
                  ...
                  for(unsigned int k=0; k<bkg_prompt_list.size(); k++){
                    ...
                    m_bkg_prompt.SearchRegion = "Preselection_MuMuE";
                  ...
                  cutop m_sig(filepath+"trilepton_mumumu_ntp_SKHN_SSSF_MuMuE_"+TString::Itoa(sig_mass, 10)+"_cat_"+catversion+".root", "Ntp_Central");
                  m_sig.SearchRegion = "Preselection_MuMuE";
                  ...
                  m_bkg_fake.SearchRegion = "Preselection_MuMuE";
